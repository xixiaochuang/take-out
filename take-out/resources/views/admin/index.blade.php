    ...
    <div id="side-nav">
        <ul id="nav">
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('分类添加','{{url('admins/classification')}}')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>分类添加</cite>
                        </a>
                    </li>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('菜品添加','{{url('admins/dishes')}}')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>菜品添加</cite>
                        </a>
                    </li>
                    <li>
                        <a onclick="xadmin.add_tab('菜品展示','{{url('admins/listmenu')}}')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>菜品展示</cite>
                        </a>
                    </li>
