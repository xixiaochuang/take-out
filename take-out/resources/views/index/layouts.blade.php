...
<table width="100%" border="0" cellspacing="0" class="nav">
    <tr>
        <td width="25" class="foot"><a href="{{url('/')}}"><img src="/index/img/1.png" width="30%" height="auto"/><span><p>外卖</p></span></a></td>
        ...
        <td width="25" class="foot"><a href="{{url('member')}}"><img src="/index/img/44.png" width="30%" height="auto"/><p>我的</p></a></td>
    </tr>
